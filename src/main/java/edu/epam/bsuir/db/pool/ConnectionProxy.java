...
/**
 * This class is wrapper to a {@code Connection},
 * which blocks it to be closed,
 * because they should be released to a
...
public class ConnectionProxy implements Connection {
    ...
    @Override
    public void close() {
        ElectiveConnectionPool.CONNECTION_POOL_INSTANCE.releaseConnection(this);
    }
